import 'package:fast_app_base/common/data/todo_repository.dart';
import 'package:fast_app_base/data/Collection/todo_db_model.dart';
  ...
  Future<SimpleResult<List<Todo>, LocalDBError>> getTodoList() async {
    if (_isar == null) {
      return SimpleResult.failure(LocalDBError(
          LocalDBErrorType.notInitialized, 'Database is not initialized.'));
    }
    try {
      final documents =
