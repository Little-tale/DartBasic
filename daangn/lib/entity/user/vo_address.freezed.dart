...
class _$AddressEntityImpl implements _AddressEntity {
  _$AddressEntityImpl(this.fullAddress, this.simpleAddress);
  ...
  @override
  String toString() {
    return 'AddressEntity(fullAddress: $fullAddress, simpleAddress: $simpleAddress)';
  }
...
abstract class _AddressEntity implements AddressEntity {
  factory _AddressEntity(final String fullAddress, final String simpleAddress) =
      _$AddressEntityImpl;
