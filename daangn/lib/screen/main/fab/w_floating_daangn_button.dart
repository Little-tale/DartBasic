...
import 'package:fast_app_base/screen/main/write/w_write.dart';
...
class FloatingDaangnButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final floatingState = ref.watch(floatingButtonStateProvider);
    final isExpanded = floatingState.isExpanded;
    final isSmall = floatingState.isSmall;
                      ...
                      child: Column(
                          ...
                          children: [
                            Tap(
                              ...
                              child: _floatItem(
                                  '내 물건 팔기', '$basePath/fab/fab_01.png'),
                            )
                          ]),
                    ),
                  ],
